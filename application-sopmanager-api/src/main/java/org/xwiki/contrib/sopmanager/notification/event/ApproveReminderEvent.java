 ...
 * @since 1.0
 */
public class ApproveReminderEvent extends AbstractReminderEvent
{
    /**
     ...
     */
    public ApproveReminderEvent(Set<String> target, Map<String, Object> eventParams)
    {
    ...
    {
        return otherEvent instanceof ApproveReminderEvent;
    }
}
