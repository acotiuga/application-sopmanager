...
/**
 * Interface for managing PDF export jobs.
 *
 * @version $Id$
 * @since 1.0
 */
@Role
public interface PDFExportJobManager
{
    /**
     * Exports a PDF file based on the given request.
     *
     ...
     */
    File export(PDFExportJobRequest request) throws Exception;
}
